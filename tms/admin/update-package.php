...
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,rooms=:prooms,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Rooms Available:</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="rooms" id="rooms" placeholder=" Rooms available" value="<?php echo htmlentities($result->rooms);?>" required>
									</div>
								</div>
