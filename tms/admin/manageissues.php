...
popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+500+',height='+700+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
}
...
<td style="color: green;background-color: green;width: 50px;"><i class="fa fa-edit"></i></td>
							<td style="background-color: red;width: 50px;"><i class="fa fa-lock"></i></td>
</tr>
						 <?php } }?>
						</tbody>
					  </table>
