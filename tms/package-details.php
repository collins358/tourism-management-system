...
$roomsbooked=$_POST['rooms'];
$status=0;
$sql="INSERT INTO tblbooking(PackageId,UserEmail,FromDate,ToDate,Comment,status,roomsbooked) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status,:roomsbooked)";
$query = $dbh->prepare($sql);
$query->bindParam(':pid',$pid,PDO::PARAM_STR);
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;"> TTMS -Package Details</h1>
	</div>
</div>
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".1s">				
				<p class="dow">PKG -<?php echo htmlentities($result->PackageId);?></p>
				<h2 style="color:#f7b731;"><?php echo htmlentities($result->PackageName);?></h2>				
				<p style="font-size:20px;"><b>Package Type :</b> <?php echo htmlentities($result->PackageType);?></p>
				<p><b>Package Location :</b> <?php echo htmlentities($result->PackageLocation);?></p>
					<p><b>Features</b> <?php echo htmlentities($result->PackageFetures);?></p>
					<h2 style="color:green;"><b>rooms Available:</b> <?php echo htmlentities($result->rooms);?></h2>			
	...
	<input type="number" min="1" name="rooms" id="number" required size="15px">
			...
			<div class="bnr-right">
				...
				<div class="grand">
					<p style="color: green;"><b>PricePerDay</b></p>
					<h3>Ksh. <?php 
